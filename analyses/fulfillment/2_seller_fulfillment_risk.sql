...
-- Business question:
-- Which sellers represent the greatest fulfillment risk based on
-- order volume, severe delivery delays, and poor customer reviews?
...
SELECT
    ...
    seller_segment
FROM segmented
WHERE seller_segment = 'Priority Intervention'
